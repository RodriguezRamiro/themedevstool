...
function LayoutPreview({ mode, onToggleTheme }) {
  return (
    <div className="layout-preview">
      <nav className="navbar">
        <span>Theme Dev Tool</span>
        <button className="cta small" onClick={onToggleTheme} type="button">
      ...
      <header className="hero">
        ...
        <p className="muted">Preview your generated theme in a real layout</p>
